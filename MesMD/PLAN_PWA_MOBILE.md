# A-SCHOOL — Spécification PWA (Progressive Web App)

> **Rôle : document de conception et de planification de la version mobile de A-SCHOOL.**
>
...
7. [Cas d'usage mobile spécifiques à A-SCHOOL](#7-cas-dusage-mobile-spécifiques-à-a-school)
...
**Conclusion : la PWA est le bon choix pour A-SCHOOL.** Elle couvre tous les cas d'usage mobile (OCR photo, dictée vocale, consultation des activités), sans coût ni dépendance externe, avec le code déjà écrit.
...
| Stratégie | Description | Usage dans A-SCHOOL |
|---|---|---|
...
**Problème mobile :** tout sur une ligne. Sur 390px, "A-SCHOOL | Générateur d'activités pédagogiques | Français | prof@ac-paris.fr | Se déconnecter" ne tient pas — overflow ou wrapping non géré.

**Solution : deux couches**

Sur mobile :
- Ligne gauche : **bouton hamburger** (ouvre la sidebar drawer) + logo **A-SCHOOL**
...
## 7. Cas d'usage mobile spécifiques à A-SCHOOL
...
Un prof en salle des profs ou en classe prend une photo d'un manuel, d'une photocopie ou d'un document avec l'appareil photo de son téléphone. Il la soumet directement à A-SCHOOL pour générer une activité.
...
Un prof visite school.afia.fr depuis son mobile. Le navigateur lui propose "Ajouter A-SCHOOL à l'écran d'accueil". Il accepte. L'app s'ouvre désormais comme une vraie app, sans barre d'adresse, avec l'icône A-SCHOOL sur son téléphone.
...
1. Créer les icônes A-SCHOOL aux formats requis :
...
4. Ajouter les méta tags dans `frontend/index.html` :
   ...
   <meta name="apple-mobile-web-app-title" content="A-SCHOOL">
...
- Logo A-SCHOOL toujours visible
...
*A-SCHOOL — Spécification PWA — Rédigé le 03/05/2026*
