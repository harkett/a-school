...
- [ ] Centraliser les réglages LLM (modèle, fournisseur, max_tokens, température, prompts) en base
     ...
     * **[ ] 4.1.d — température administrable** — pas démarrée ; ressort avec 4.1.e (l'adaptateur Anthropic ignore la température) et à la bascule Claude (cf. Rappels transverses). À traiter à ce moment-là, pas en isolé.
