...
--
-- Une séquence par matière du référentiel d'éveil 0-3 ans (Crèche · BMG_0-3).
...
((SELECT id FROM users WHERE email='demo.creche@aschool.fr'),
 ...
 'Motricité et coordination', 'BMG_0-3', now(), now()),
...
((SELECT id FROM users WHERE email='demo.creche@aschool.fr'),
 ...
 'Réflexion, raisonnement et repérage de l''environnement', 'BMG_0-3', now(), now()),
...
((SELECT id FROM users WHERE email='demo.creche@aschool.fr'),
 ...
 'Créativité, imagination et expression', 'BMG_0-3', now(), now()),
...
((SELECT id FROM users WHERE email='demo.creche@aschool.fr'),
 ...
 'Aptitudes sociales, confiance et sécurité affective', 'BMG_0-3', now(), now());
