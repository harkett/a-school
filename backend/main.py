...
with engine.connect() as _conn:
    for _col in [
        ...
        "CREATE TABLE IF NOT EXISTS feature_votes (id INTEGER PRIMARY KEY AUTOINCREMENT, user_email VARCHAR(255) NOT NULL, feature_key VARCHAR(64) NOT NULL, user_id INTEGER, created_at DATETIME, UNIQUE(user_email, feature_key))",
        "CREATE TABLE IF NOT EXISTS tool_usage_logs (id INTEGER PRIMARY KEY AUTOINCREMENT, user_email VARCHAR(255) NOT NULL, tool VARCHAR(32) NOT NULL, score_label VARCHAR(32), user_id INTEGER, created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP)",
