...
import DetailAppelIA from '../components/DetailAppelIA.jsx'
...
export default function AdminIAJournal() {
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      {/* Les mises en forme de l'écran (heure, durée, montants, traduction du motif d'arrêt)
          sont passées à la fenêtre : elles vivent ici, elles ne se réécrivent pas ailleurs. */}
      {detail && (
        <DetailAppelIA
          ligne={detail}
          lignes={lignes}
