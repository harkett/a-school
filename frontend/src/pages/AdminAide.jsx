    ...
    items: [
      ...
      },
      {
        ...
        contenu: [
          ...
          'Onglet « Longueur (tokens) » : longueur maximale de la réponse de l\'IA, en tokens. La valeur appliquée est celle de la FICHE DU MODÈLE en service (à défaut, celle de son fournisseur) : c\'est ce que le modèle accepte, pas un réglage de confort.',
          'L\'écran liste TOUS les outils qui appellent l\'IA — un par ligne, lue en base : rien n\'y est écrit à la main, et un outil ajouté apparaît de lui-même.',
          'La longueur VOULUE d\'un texte se dit dans son prompt, jamais ici : ce nombre ne fait que couper si la réponse dépasse. Trop bas, il tronque au milieu d\'une phrase.',
          ...
          'Onglet « Prompts » : le texte d\'instruction exact envoyé à l\'IA pour chaque outil (détecteur d\'ambiguïtés, analyse de consigne…). On choisit l\'outil dans une liste, on édite son texte, on enregistre. Pris en compte immédiatement, sans redémarrage.',
