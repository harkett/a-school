    ...
    items: [
      ...
      },
      {
        ...
        contenu: [
          ...
          'Surcharges propres : Détecteur d\'ambiguïtés (3000). Les surcharges « séquence » et « optimiseur » restent en base mais ne servent plus : ces deux outils ont été démolis avec l\'ancien monde (30/07).',
          ...
          'Onglet « Prompts » : le texte d\'instruction exact envoyé à l\'IA pour chaque outil (détecteur d\'ambiguïtés, analyse de consigne…). On choisit l\'outil dans une liste, on édite son texte, on enregistre. Pris en compte immédiatement, sans redémarrage. Les entrées « séquence » et « optimiseur » sont des restes de l\'ancien monde, démoli le 30/07.',
