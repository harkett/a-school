...
const ETAPES = [
  { n: 1, titre: 'La liste (colonne de gauche)',
    desc: "Une ligne par séance : la pastille de couleur de son couple matière-niveau, le thème en titre, puis le mode (Séance standard, Remédiation, Approfondissement, Autonomie guidée), le niveau et la durée. Le badge date est bleu quand la séance est récente. Cliquez une ligne : son détail s'affiche à droite." },
  ...
  { n: 3, titre: 'Le détail (colonne de droite)',
    desc: "Le contexte que vous aviez fourni, les activités rattachées à la séance (« Ouvrir » recharge l'activité dans son écran ; rattacher ou détacher se fait dans l'écran Séance, via « Reprendre ») et le déroulé généré. « HTML » ouvre l'aperçu mis en forme (avec Imprimer) ; « Reprendre » rouvre la séance dans son écran pour la modifier ou la régénérer — une séance d'un autre couple demande d'abord de passer sur le profil correspondant. Le bouton sous « Nouvelle séance » cache ou réaffiche cette colonne : cachée, la liste prend toute la largeur." },
    ...
    <FenetrePro titre="Comment ça marche" onFermer={onFermer}>
      <div style={{ padding: '14px 16px', overflowY: 'auto', flex: 1, minHeight: 0,
        ...
        <p style={{ margin: 0, fontSize: 12.5, color: '#374151', lineHeight: 1.5 }}>
          <strong style={{ color: '#1e293b' }}>« Mes contenus → Séances »</strong> réunit toutes vos séances :
